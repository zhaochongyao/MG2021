...
public class SerializableDictionaryDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (property.isExpanded)
        {
            ...
            if (VisibleRect == null)
            {
                ...
                if (tyGUIClip != null)
                {
                    var piVisibleRect = tyGUIClip.GetProperty("visibleRect",
    ...
    private static GUIContent[] pairElementLabels => s_pairElementLabels ??
                                                     (s_pairElementLabels = new[]
                                                         {new GUIContent("Key"), new GUIContent("=>")});
