...
{
    public class ChatLineNoName : MonoBehaviour
    {
        ...
        { 
            ...
            if (chatLine.MemePic == null)
            {
                ...
                _rectTransform.sizeDelta = new Vector2
                {
                    ...
                    y = Mathf.Abs(_textBackgroundRectTrans.position.y) * 2 + _textBackgroundRectTrans.sizeDelta.y
                };
            }
            else
            {
                ...
                {
                    x = _rectTransform.sizeDelta.x,
                    y = Mathf.Abs(_picMask.position.y) * 2 + _picMask.sizeDelta.y
                };
            }
        }
    }
